...
> Install latest release
     ...
     cordova plugin add francescoextraweb/cordova-plugin-ios-xhr
     
> Or install from github master

     cordova plugin add https://github.com/francescoextraweb/cordova-plugin-ios-xhr
     
### Uninstall

     cordova plugin rm francescoextraweb/cordova-plugin-ios-xhr
